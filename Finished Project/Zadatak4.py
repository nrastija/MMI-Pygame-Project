...
avion_spori = avion_slika.get_rect()
...
brzina_aviona = 200  # piksela po sekundi
...
while True:
    ...
    if brojac == 5:
        avion_spori.x = avion_brzi.x
        avion_spori.x += pomakX_os * proteklo_vrijeme * brojac
        avion_spori.y += pomakY_os * proteklo_vrijeme * brojac
        brojac = 0
    ...
    screen.blit(avion_slika, (avion_spori.x, avion_spori.y))
